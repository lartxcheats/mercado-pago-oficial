...
.balance-card { background-color: #fff; padding: 22px 20px 20px; border-radius: 0 20px 20px 20px; margin: 0 12px 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); position: relative; z-index: 1; }
