...
.tab { padding: 11px 18px; border-radius: 16px 16px 0 0; border: none; background-color: transparent; font-size: 13.5px; font-weight: 500; color: rgba(0,0,0,0.5); cursor: pointer; white-space: nowrap; position: relative; z-index: 2; font-family: 'Inter', sans-serif; transition: color 0.15s; }
.tab.active { background-color: #f0f0f0; color: #1A1A1A; font-weight: 700; }
...
.extract-link { color: #4361EE; text-decoration: none; font-size: 13px; font-weight: 600; margin-top: 6px; white-space: nowrap; display: flex; align-items: center; gap: 2px; }
